...
public class Scooter {
    ...
    public Scooter(int scooterID, String scooterModel, int scooterMaxVelocity, String scooterColor, int scooterAvailability, int scooterBasket, int scooterRange, int scooterPrice, int scooterBattery) {
