...
public class ScooterAddingPanelController {
    ...
    public void onConfirmButtonClicked(){
        ...
        flag1 = Validate.isNumeric(addPanelVelocityField.getText()); //dodaj trim
        flag2 = Validate.isNumeric(addPanelBasketField.getText());
        flag3 = Validate.isNumeric(addPanelPriceField.getText());
        flag4 = Validate.isNumeric(addPanelRangeField.getText());
       ...
       if(flag1 && flag2 && flag3 && flag4) {
           ...
           scooter.setScooterPrice(Integer.parseInt(addPanelPriceField.getText().trim()));
