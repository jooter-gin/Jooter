...
public class UserRentalsController {
    ...
    @FXML
    TableColumn<ScooterJoin,Integer> UserRentsPrice = new TableColumn<>();
    @FXML
    ...
    public void initialize(){
        ...
        try {
            ResultSet joinSet = DataSource.getInstance().joinScooterOnRentals();
            while(joinSet.next()){
                ...
                sj.setScooterPrice(joinSet.getInt(DataSource.getColumnScooterPrice()));
    ...
    public void onReturnButtonClicked(){
        ...
        if(UserRentsTable.getSelectionModel().getSelectedItem() != null) {
            ...
            int id = sj.getRentsScooterID();
            Timestamp returnDate = sj.getReturnDate();
           // System.out.println(returnDate);
            if(returnDate == null) {
                //int rowIndex = UserRentsTable.getSelectionModel().getSelectedIndex();
                Scooter scooter = new Scooter();
                scooter.setScooterID(id);
                scooter.setScooterAvailability(1);
                //System.out.println(id);
                //System.out.println(scooter.getScooterAvailability());
                DataSource.getInstance().updateScooterAvailability(scooter);
                // System.out.println(id);
                Timestamp timestamp = new Timestamp(System.currentTimeMillis());
                DataSource.getInstance().updateReturnDate(timestamp, id);
                ...
                try {
                    ...
                    while (joinSet.next()) {
                        ...
                        sjj.setScooterPrice(joinSet.getInt(DataSource.getColumnScooterPrice()));
