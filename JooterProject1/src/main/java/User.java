...
public class User extends Validate {
    ...
    public User(int userId, String userName, String userSurname, String userLogin, String userPassword, String userEmail, String userCardNo, int userAccountBalance) {
        this.userId = userId;
